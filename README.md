...
Included are a collection of ImageJ Macros, Jython/Python scripts, and ilastik classification files to be ran sequentially to process nuclear, Relish, and RhoBAST channel signals.
  ...
  - Step 8:  optional ImageJ macro easy visualization and manual sorting of all cells based on resulting masks for cytoplasm, nuclei, and RhoBAST foci (based on the criteria listed in Methods). 
